...
<div class="font-figma min-h-screen bg-[#F8FAFC] flex flex-col md:flex-row">
    ...
    <!-- Ditambahkan transisi, translate-x responsif, dan penyesuaian z-index untuk kenyamanan mobile -->
    <aside id="sidebar-menu" class="fixed inset-y-0 left-0 z-50 w-72 bg-white border-r border-gray-100 flex flex-col justify-between transition-transform duration-300 transform -translate-x-full md:translate-x-0 md:sticky md:top-0 md:h-screen rounded-r-[36px] md:rounded-r-none shadow-lg md:shadow-none shrink-0">
        
        <!-- Bagian Atas Sidebar (Logo & Navigasi) -->
        <div class="p-8 flex- flex flex-col overflow-y-auto">
            <!-- Brand Logo SiLapor -->
    ...
    <!-- KONTEN UTAMA (Kanan) -->
    <!-- Ditambahkan p-4 pada mobile dan p-6 md:p-10 pada tablet/desktop agar isi tidak terlalu rapat -->
    <main class="flex-1 px-4 py-6 md:px-10 md:py-8 space-y-8 overflow-x-hidden w-full min-w-0">
        ...
        <!-- Ditambahkan gap-4 dan flex-wrap agar header mengalir anggun di layar HP -->
        <header class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-4">
            ...
            <!-- Penambahan w-full sm:w-auto agar memenuhi lebar layar kecil dengan manis -->
            <div class="bg-[#0090F5] text-white px-5 py-2.5 rounded-2xl flex items-center gap-3.5 shadow-md w-full sm:w-auto justify-start sm:justify-center">
        ...
        <!-- Ditransisikan dari 1 kolom di mobile, 2 kolom di tablet, hingga 3 kolom di desktop -->
        <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <!-- Card 3: Selesai -->
            <!-- col-span-1 sm:col-span-2 lg:col-span-1 membuat letaknya tetap stabil di semua ukuran layar -->
            <div class="bg-white border border-gray-150 rounded-[28px] p-7 flex items-center justify-between shadow-figma-card sm:col-span-2 lg:col-span-1">
                <div class="flex items-center gap-5">
        ...
        <section class="bg-white border border-gray-150 rounded-[32px] overflow-hidden shadow-figma-container">
            <!-- Header Atas Tabel -->
            <!-- flex-col sm:flex-row agar judul dan tombol sejajar saat lebar layar cukup -->
            <div class="px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 border-b border-gray-100">
                ...
                <!-- w-full sm:w-auto agar tombol memanjang penuh di layar HP dan kembali normal di tablet/desktop -->
                <a href="/lapor/manual" class="flex items-center justify-center gap-2 bg-[#0090F5] hover:bg-[#007cd5] text-white px-6 py-3 rounded-xl font-bold text-sm shadow-md transition-colors w-full sm:w-auto">
            ...
            <!-- Area Tabel Utama -->
            <!-- Penambahan overflow-x-auto menjamin tabel dapat digeser horizontal dengan scrollbar cantik di mobile tanpa merusak seluruh layout halaman -->
