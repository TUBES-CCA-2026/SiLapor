...
<main class="w-full min-w-0 px-4 py-6 md:px-8 md:py-8 space-y-6">
    <header class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-2">
        <div class="flex items-center gap-3">
            ...
            <h1 class="text-lg sm:text-xl md:text-2xl font-extrabold text-[#2C3E50] tracking-tight uppercase">TAMBAH USER</h1>
        </div>
    ...
    <div class="page-card-body">
        ...
        <form method="POST" action="{{ route('admin.users.store') }}" style="display: grid; gap: 1rem;">
            ...
            <div>
                ...
                <input name="nama" value="{{ old('nama') }}" required class="form-control">
            </div>
            <div>
            ...
            <div>
                <label class="field-label">Password Awal</label>
            ...
            <div style="display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 1rem;">
                ...
                <div><label class="field-label">NIM</label><input name="nim" value="{{ old('nim') }}" class="form-control"></div>
                <div><label class="field-label">Jurusan</label><input name="jurusan" value="{{ old('jurusan') }}" class="form-control"></div>
                <div><label class="field-label">Peminatan</label><input name="peminatan" value="{{ old('peminatan') }}" class="form-control"></div>
                <div style="grid-column: 1 / -1;"><label class="field-label">Penanggung Jawab</label><input name="penanggung_jawab" value="{{ old('penanggung_jawab') }}" class="form-control"></div>
            </div>
