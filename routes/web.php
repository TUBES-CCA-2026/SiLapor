...
Route::controller(ForgotPasswordController::class)
    ->group(function () {
        ...
        Route::get('/forgot-password/otp', 'showOtpForm')
            ->name('password.otp.form');

        Route::post('/forgot-password/otp', 'verifyOtp')
            ->name('password.otp.verify');

        Route::post('/forgot-password/otp/resend', 'resendOtp')
...
Route::prefix('lapor')
    ->name('pengaduan.')
    ->group(function () {
        Route::get('/qr/{qr_code}', [
            PengaduanController::class,
            'createQr',
        ])->name('qr.create');

        Route::post('/qr/{qr_code}', [
            PengaduanController::class,
            'storeQr',
        ])->name('qr.store');
...
Route::middleware('auth')->group(function () {
    ...
    */
    ...
    Route::middleware('role:asisten')->group(function () {
        ...
        Route::patch('/tindak-lanjut/{tindakLanjut}', [
            TindakLanjutController::class,
            'update',
    ...
    */
    ...
    Route::middleware('role:koordinator_lab')
        ->group(function () {
            Route::get('/detail-laporan', [
                DashboardController::class,
                'detailLaporan',
            ...
            Route::post('/pengaduan/{pengaduan}/assign', [
                TindakLanjutController::class,
                'assign',
    ...
    */
    ...
    Route::middleware('role:laboran')
        ->group(function () {
            Route::get('/rekapsulasi', [
                DashboardController::class,
                'detailLaporan',
            ])->name('rekapsulasi.index');
            ...
            Route::patch('/laboratorium/{laboratorium}', [
                LaboratoriumController::class,
                'update',
            ])->name('laboratorium.update');

            Route::delete('/laboratorium/{laboratorium}', [
                LaboratoriumController::class,
                'destroy',
