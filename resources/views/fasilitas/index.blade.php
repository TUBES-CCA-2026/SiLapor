...
<<<<<<< HEAD
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(220px, 1fr)); gap: 1rem;">
            @forelse ($fasilitas as $f)
                <div style="background: #fff; border: 1px solid #E5E7EB; border-radius: 1.25rem; padding: 1.25rem; text-align: center;">
                    ...
                    <div style="display: flex; justify-content: center; margin-bottom: 1rem;" id="qr-{{ $f->id_fasilitas }}"></div>
                    <script>
                        new QRCode(document.getElementById('qr-{{ $f->id_fasilitas }}'), {
                            text: '{{ $f->scanUrl() }}', width: 140, height: 140,
                        });
                    </script>
