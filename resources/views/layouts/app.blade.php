...
<head>
    ...
    <style>
        ...
        .global-notification-backdrop[hidden] {
        ...
        .global-notification-button:hover {
            background: #007CD5;
        }
    </style>
...
<body class="bg-gray-50 text-gray-800">
    ...
    @php
        $globalNotificationType = session('success')
            ? 'success'
            : ((session('error') || $errors->any()) ? 'error' : null);

        $globalNotificationMessage = session('success')
            ?: (session('error') ?: ($errors->any() ? $errors->first() : null));

        $globalNotificationTitle = $globalNotificationType === 'success'
            ? 'Berhasil'
            : 'Gagal';
    @endphp
        ...
        <div id="global-notification-popup" class="global-notification-backdrop">
            <div class="global-notification-card" role="dialog" aria-modal="true">
                <div class="global-notification-header">
                    <h2 class="global-notification-title">
                    ...
                    <button
                        ...
                        onclick="document.getElementById('global-notification-popup')?.remove()"
                    >
                        &times;
                    </button>
                </div>
                ...
                <div class="global-notification-body">
                    ...
                    <p class="global-notification-message">
